...
<body>
    ...
    $query2 = "select count(idPost) as qtd_post from post";
    ...
    $query = $pdo->query("select *  FROM post
                        ...
                        ON post.produtorID=produtor.idProdutor and post.categoriaID=categoria.idCategoria ORDER BY idPost desc limit $inicio, $registro");
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <h4><a href="cadastrar-post.php">Criar post</a></h4>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="width: 100px;"><img src="./assets/img/<?php echo $linha['imgPost']; ?>" alt="" style="width: 100%;"></td>
                                    <td><?php echo $linha['tituloPost']; ?></td>
